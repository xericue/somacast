...
;
const metadata = {
    title: 'Safe Space - Voice Wellness Support',
    description: 'A private, calming space that listens to your voice, understands your stress, and provides immediate support through evidence-based breathing exercises.',
    generator: 'v0.app',
    icons: {
        icon: [
            {
